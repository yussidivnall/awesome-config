...
--@return a new panel
function layout_panel.new(args)
	local ret={}
	...
	ret.pop_timer=nil
	ret.pop_on=false
	setmetatable(ret,{__index=layout_panel})
	return ret
end
...
function layout_panel.set_payload(me,args)
...
function layout_panel.set_actions(me,args)
...
function layout_panel.update(me)
